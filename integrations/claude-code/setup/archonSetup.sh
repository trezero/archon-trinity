...
for entry in ".claude/plugins/" ".claude/skills/" ".claude/archon-config.json" ".claude/archon-state.json" ".claude/archon-memory-buffer.jsonl" ".claude/settings.local.json" ".mcp.json" ".archon/"; do
